...
; BATTLEPLAN SINGLE 7
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	291,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN SINGLE 6
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	323,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN SINGLE 5
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	355,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN SINGLE 4
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	387,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN SINGLE 3
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	419,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN SINGLE 2
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	451,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN SINGLE 1
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	483,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
...
; BATTLEPLAN BOTTOM
	...
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	0,0							; sprite_x						; 16.16 x value to position at
	dc.w	515,0								; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	320							; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
