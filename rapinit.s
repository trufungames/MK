...
; Fighter Ending
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	320*256						; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	320							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; TITLE SCREEN - FIGHTERS LEFT 1
	...
	dc.l	268								; sprite_height					; height of sprite (in pixels)
	dc.l	is_normal						; sprite_flip					; flag for mirroring data left<>right
	dc.l	0								; sprite_coffx					; x offset from center for collision box center
	dc.l	0								; sprite_coffy					; y offset from center for collision box center	
	dc.l	16							; sprite_hbox					; width of collision box
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	64*268						; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	64							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
	dc.l	edge_ignore						; sprite_wrap					; wrap on screen exit, or remove
	...
	dc.l	1								; sprite_hitpoint				; Hitpoints before death
	dc.l	2								; sprite_damage					; Hitpoints deducted from target
	dc.l	64						; sprite_gwidth					; GFX width (of data)
...
; THE PALACE CLOUDS1 Object
	...
	dc.l	BMP_PALACE_CLOUDS1					; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	160*32/2					; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	160/2							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; THE PALACE CLOUDS2 Object
	...
	dc.l	96							; sprite_hbox					; width of collision box
	dc.l	32							; sprite_vbox					; height of collision box
	dc.l	BMP_PALACE_CLOUDS2					; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	96*32/2					; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	96/2							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; SECONDARY BACKGROUND Object (256 colors)
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_inactive						; sprite_active					; sprite active flag
	dc.w	0,0								; sprite_x						; 16.16 x value to position at
	dc.w	0,0								; sprite_y						; 16.16 y value to position at
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	336*144					; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	336							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
	dc.l	edge_ignore						; sprite_wrap					; wrap on screen exit, or remove
	...
	dc.l	1								; sprite_hitpoint				; Hitpoints before death
	dc.l	2								; sprite_damage					; Hitpoints deducted from target
	dc.l	336						; sprite_gwidth					; GFX width (of data)
...
; MONKS Object (courtyard stage)
	...
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	576								; sprite_width					; width of sprite (in pixels)
	dc.l	32								; sprite_height					; height of sprite (in pixels)
	dc.l	is_normal						; sprite_flip					; flag for mirroring data left<>right
	dc.l	0								; sprite_coffx					; x offset from center for collision box center
	dc.l	0								; sprite_coffy					; y offset from center for collision box center	
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_COURTYARD_MONKS 				; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	576*32/2					; sprite_framesz				; size per frame in bytes of sprite data
	...
	dc.l	1								; sprite_hitpoint				; Hitpoints before death
	dc.l	2								; sprite_damage					; Hitpoints deducted from target
	dc.l	576/2						; sprite_gwidth					; GFX width (of data)	
...
; PRIMARY BACKGROUND Object (16 colors)
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_inactive						; sprite_active					; sprite active flag
	dc.w	-8,0								; sprite_x						; 16.16 x value to position at
	dc.w	0,0								; sprite_y						; 16.16 y value to position at
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	768*240					; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	768							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; Blood Pool Object
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	32*16/2						; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	32/2							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	1								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; FOREGROUND SPIKES
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	768*58					; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	768							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; Text/Particle Layer
	...
	dc.w	0,0																; sprite_yadd		; 16.16 y addition for sprite movement
	dc.l	raptor_particle_buffer_width									; sprite_width		; width of sprite (in pixels)
	dc.l	38									; sprite_height		; height of sprite (in pixels)
	dc.l	is_normal														; sprite_flip		; flag for mirroring data left<>right
	dc.l	0																; sprite_coffx		; x offset from center for collision box center
	dc.l	0																; sprite_coffy		; y offset from center for collision box center	
	dc.l	0																; sprite_hbox		; width of collision box
	...
	dc.l	is_RGB															; (CRY/RGB)			; bitmap GFX type
	dc.l	is_trans														; (TRANSPARENCY)	; bitmap TRANS flag
	dc.l	(raptor_particle_buffer_width/2)*38	; sprite_framesz	; size per frame in bytes of sprite data
	dc.l	raptor_particle_buffer_width/2									; sprite_bytewid	; width in bytes of one line of sprite data
	dc.l	0																; sprite_animspd	; frame delay between animation changes
	dc.l	0																; sprite_maxframe	; number of frames in animation chain
	dc.l	ani_rept														; sprite_animloop	; repeat or play once
...
; BATTLEPLAN TOP
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_TOP						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	320*144/2						; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	320/2							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; BATTLEPLAN INTERSECTION
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_INTERSECTION						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
...
; BATTLEPLAN ENDURANCE 3
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_ENDURANCE						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	320*32/2						; sprite_framesz				; size per frame in bytes of sprite data
...
; BATTLEPLAN SINGLE 7
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_SINGLE						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	320*32/2						; sprite_framesz				; size per frame in bytes of sprite data
...
; BATTLEPLAN BOTTOM
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_BOTTOM						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	320*32/2						; sprite_framesz				; size per frame in bytes of sprite data
...
; BATTLEPLAN SHANG TSUNG
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_SHANGTSUNG						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	32*48/2						; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	32/2							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
...
; BATTLEPLAN GORO
	...
	dc.l	16							; sprite_hbox					; width of collision box
	dc.l	16							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_GORO						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	32*48/2						; sprite_framesz				; size per frame in bytes of sprite data
...
; BATTLEPLAN PORTRAITS
	dc.l	15								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_inactive						; sprite_active					; sprite active flag
	dc.w	104,0							; sprite_x						; 16.16 x value to position at
	...
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	128*32						; sprite_framesz				; size per frame in bytes of sprite data
	dc.l	128							; sprite_bytewid				; width in bytes of one line of sprite data
	dc.l	0								; sprite_animspd				; frame delay between animation changes
	dc.l	0								; sprite_maxframe				; number of frames in animation chain
	dc.l	ani_rept						; sprite_animloop				; repeat or play once
	dc.l	edge_ignore						; sprite_wrap					; wrap on screen exit, or remove
	...
	dc.l	1								; sprite_hitpoint				; Hitpoints before death
	dc.l	2								; sprite_damage					; Hitpoints deducted from target
	dc.l	128							; sprite_gwidth					; GFX width (of data)
...
; BATTLEPLAN PLAYER PORTRAIT OUTLINE
	...
	dc.l	0								; sprite_coffx					; x offset from center for collision box center
	dc.l	0								; sprite_coffy					; y offset from center for collision box center	
	dc.l	32							; sprite_hbox					; width of collision box
	dc.l	64							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN_MARKER						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	32*32/2						; sprite_framesz				; size per frame in bytes of sprite data
...
; BATTLEPLAN PLAYER PORTRAIT OUTLINE
	...
	dc.l	32							; sprite_hbox					; width of collision box
	dc.l	64							; sprite_vbox					; height of collision box
	dc.l	BMP_BATTLEPLAN						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	96*16/2						; sprite_framesz				; size per frame in bytes of sprite data
