...
__Z17fighterInitializeP7FighterbP12SoundHandlerP11ImpactFrameS4_S4_S4_S4_S4_S4_S4_S4_S4_S4_S4_S4_:
	...
	move.l 8(%fp),%a2
	move.l 12(%fp),%d2
	move.l #0x400ccccd,318(%a2)
	clr.l 322(%a2)
	move.l #0xc1800000,326(%a2)
	move.l #0xc1a80000,330(%a2)
	move.l #0xc0800000,334(%a2)
	move.l #0x40a00000,338(%a2)
	clr.b 124(%a2)
	clr.b 125(%a2)
	clr.b 204(%a2)
	clr.b 205(%a2)
	...
	move.l 68(%fp),448(%a2)
	clr.l 232(%a2)
	move.l #0x40000000,246(%a2)
	move.l #0x40800000,250(%a2)
	move.l #0x40d00000,254(%a2)
	move.l #0x41000000,258(%a2)
	clr.l 266(%a2)
	move.l #0x40f00000,262(%a2)
	moveq #1,%d0
	move.l %d0,284(%a2)
	clr.l 288(%a2)
	clr.l 276(%a2)
