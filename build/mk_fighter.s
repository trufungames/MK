...
__Z17fighterInitializeP7FighterbP12SoundHandlerP11ImpactFrameS4_S4_S4_S4_S4_S4_S4_:
	...
	move.l 8(%fp),%a0
	move.l 12(%fp),%d1
	move.l #0x400ccccd,216(%a0)
	clr.l 220(%a0)
	move.l #0xc1900000,224(%a0)
	move.l #0xc1d00000,228(%a0)
	move.l #0x433c0000,232(%a0)
	move.l 16(%fp),206(%a0)
	move.l 20(%fp),236(%a0)
	move.l 24(%fp),240(%a0)
	move.l 28(%fp),244(%a0)
	...
	move.l %d0,166(%a0)
	move.l %d0,170(%a0)
	move.l #0x40900000,174(%a0)
	move.l #0x40600000,178(%a0)
	move.l #0x3f800000,182(%a0)
	move.b #1,%d0
	move.l %d0,194(%a0)
	clr.l 186(%a0)
	clr.b 108(%a0)
