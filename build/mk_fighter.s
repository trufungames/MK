...
__Z17fighterInitializeP7FighterbP12SoundHandlerP11ImpactFrameS4_S4_S4_S4_S4_S4_S4_S4_S4_S4_S4_S4_:
	...
	move.l 8(%fp),%a2
	move.l 12(%fp),%d2
	move.l #0x400ccccd,306(%a2)
	clr.l 310(%a2)
	move.l #0xc1800000,314(%a2)
	move.l #0xc1a80000,318(%a2)
	move.l #0xc0800000,322(%a2)
	move.l #0x40a00000,326(%a2)
	clr.b 109(%a2)
	clr.b 110(%a2)
	clr.b 184(%a2)
	clr.b 185(%a2)
	...
	move.l 68(%fp),432(%a2)
	clr.l 212(%a2)
	move.l #0x40000000,226(%a2)
	move.l #0x40000000,230(%a2)
	move.l #0x40000000,234(%a2)
	move.l #0x40800000,238(%a2)
	move.l #0x40d00000,242(%a2)
	move.l #0x41000000,246(%a2)
	clr.l 254(%a2)
	move.l #0x40f00000,250(%a2)
	move.l #0x3f800000,258(%a2)
	moveq #1,%d0
	move.l %d0,272(%a2)
	clr.l 276(%a2)
	clr.l 264(%a2)
...
.L303:
	tst.b 147(%a1)
	jeq .L282
	move.w 280(%a1),186(%a0)
	move.w 282(%a1),188(%a0)
	move.l (%a1),%d0
	subq.l #5,%d0
	moveq #2,%d1
	cmp.l %d0,%d1
...
.L764:
	...
	move.w raptor_ticks,%a0
	move.l %a0,268(%a2)
	move.w 186(%a2),280(%a2)
	move.w 188(%a2),282(%a2)
	clr.w 186(%a2)
	clr.w 188(%a2)
	move.b #1,144(%a2)
	move.b #1,148(%a2)
