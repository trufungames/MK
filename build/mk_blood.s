...
.L63:
	...
	add.l %d1,%d3
	add.l %d3,%d3
	move.l #_bloodPools+8,%d1
	move.l %d3,%a1
	move.b #1,(%a1,%d1.l)
	move.l #_bloodPools,%d1
	move.l %d1,%a1
	move.l (%a1,%d3.l),%d1
	move.l %d1,%d4
	add.l %d1,%d4
...
__Z10bloodSprayiii:
	...
	move.l %d0,_bloodDirection
	move.l sprite,%a0
	move.w 10(%fp),9608(%a0)
	move.w 14(%fp),9612(%a0)
	moveq #1,%d1
	cmp.l %d0,%d1
	seq %d0
	ext.w %d0
