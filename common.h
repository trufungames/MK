...
#define ENDING FMV + 1
#define TITLE_FIGHTERS ENDING + 1
...
#define STAGE_PALACE_CLOUDS1 STAGE_PIT_CLOUDS1 + 8
#define STAGE_GATES_TEMPLE STAGE_PALACE_CLOUDS1 + 2
#define STAGE_WARRIOR_BUSH STAGE_GATES_TEMPLE + 1
#define STAGE_SECONDARY_BACKGROUND STAGE_WARRIOR_BUSH + 4
#define STAGE_SECONDARY_BACKGROUND_8BIT STAGE_SECONDARY_BACKGROUND + 1
#define STAGE_GORO_EYES STAGE_SECONDARY_BACKGROUND_8BIT + 1
#define STAGE_MONKS STAGE_GORO_EYES + 2
#define STAGE_PRIMARY_BACKGROUND STAGE_MONKS + 1
#define STAGE_PRIMARY_BACKGROUND_4BIT STAGE_PRIMARY_BACKGROUND + 1
#define STAGE_GATES_FLAME STAGE_PRIMARY_BACKGROUND_4BIT + 1
#define THRONE_SHANG_TSUNG STAGE_GATES_FLAME + 4
...
#define BATTLEPLAN_TOP FIGHT + 3
#define BATTLEPLAN_SHANGTSUNG BATTLEPLAN_TOP + 15
#define BATTLEPLAN_GORO BATTLEPLAN_SHANGTSUNG + 1
#define BATTLEPLAN_PORTRAITS BATTLEPLAN_GORO + 1
#define BATTLEPLAN_PLAYER_MARKER BATTLEPLAN_PORTRAITS + 15
#define BATTLEPLAN BATTLEPLAN_PLAYER_MARKER + 1
#define BATTLEPLAN_TEXT BATTLEPLAN + 1
//#define HUD FIGHT + 1
...
#define FIGHTER_PROJECTILE_X_SPEED 14
...
#define FIGHTER_RAIDEN_TORPEDO_X_SPEED 12
...
#define FIGHTER_KASUMI_ROLL_X_SPEED 12
#define FIGHTER_KASUMI_ROLL_BLOCKED_X_SPEED 3
#define FIGHTER_MAX_DISTANCE_FROM_OPPONENT 260
...
#define FIGHTER_FATALITY_MID_RANGE_MIN_X 40
...
#define FIGHTER_BATTLEPLAN_STEP_Y 2
//-----------------------------------------------------------------------------------------------------
...
#define STAGE_WARRIOR_FLAME1_X 135
#define STAGE_WARRIOR_FLAME2_X 338
#define STAGE_WARRIOR_FLAME3_X 428
#define STAGE_WARRIOR_FLAME4_X 639
//-----------------------------------------------------------------------------------------------------
#define SCREEN_TOTAL_COUNT 8
#define SCREEN_PREALPHA 0
#define SCREEN_TRUFUN 1
#define SCREEN_TITLE_SCREEN 2
#define SCREEN_MAIN_MENU 3
#define SCREEN_ATTRACT_MODE 4
#define SCREEN_CHOOSE_YOUR_FIGHTER 5
#define SCREEN_VS_BATTLE5 6
#define SCREEN_FIGHT 7
