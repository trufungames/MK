...
sample51:	dc.l	cage_yeah_sam		; start of sample
			dc.l	cage_yeah_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
s51_vol:		dc.b	163				; volume
			dc.l	8000			; default play rate

sample52:	dc.l	kano_yell_sam		; start of sample
			dc.l	kano_yell_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
...
sample65:	dc.l	sonya_rings_sam		; start of sample
			dc.l	sonya_rings_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
...
sample78:	dc.l	scorpion_teleport_sam		; start of sample
			dc.l	scorpion_teleport_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
s78_vol:		dc.b	255				; volume
			dc.l	8000			; default play rate

sample79:	dc.l	subzero_slide_sam		; start of sample
			dc.l	subzero_slide_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
...
sample82:	dc.l	kasumi_fireball_sam		; start of sample
			dc.l	kasumi_fireball_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
...
sample93:	dc.l	fatality_scream_male_sam		; start of sample
			dc.l	fatality_scream_male_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
s93_vol:		dc.b	255				; volume
			dc.l	8000			; default play rate

sample94:	dc.l	fatality_scream_female_sam		; start of sample
			dc.l	fatality_scream_female_sam_end	; end of sample
			dc.l	0				; repeat offset
			dc.l	0				; repeat length
			dc.w	0				; <NULL>
			dc.b	0				; fine tune
